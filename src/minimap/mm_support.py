...
class MMObjectID(IntEnum):
    ...
    WITCH_HUT = 5010
    UNIVERSITY = 5011
    SEAFARING_ACADEMY = 5012

    MINE = 6000
    WAREHOUSE = 6001

    WAR_MACHINE_FACTORY = 7000
    CANNON_YARD = 7001
    HILL_FORT_ORIGINAL = 7002
    HILL_FORT_HOTA = 7003

    RALLY_FLAG = 8000
    IDOL_OF_FORTUNE = 8001
    FOUNTAIN_OF_YOUTH = 8002
    MINERAL_SPRING = 8003
    OASIS = 8004
    WATERING_HOLE = 8005
    ...
    TEMPLE = 8010
    BUOY = 8011
    TEMPLE_OF_LOYALTY = 8012

    FAERIE_RING = 8020
    FOUNTAIN_OF_FORTUNE = 8021
    SWAN_POND = 8022
    MERMAIDS = 8023
...
MM_OBJECT_COLORS = {
    ...
    MMObjectID.WITCH_HUT: (0xFF, 0xA4, 0x64),
    MMObjectID.UNIVERSITY: (0xFF, 0xCF, 0x76),
    MMObjectID.SEAFARING_ACADEMY: (0x76, 0xFF, 0xFF),
    MMObjectID.MINE: (0xFF, 0xFF, 0x00),
    MMObjectID.WAREHOUSE: (0xFF, 0xFF, 0xFF),
    MMObjectID.WAR_MACHINE_FACTORY: (0xFF, 0xFF, 0x00),
    MMObjectID.CANNON_YARD: (0xFF, 0xFF, 0xFF),
    MMObjectID.HILL_FORT_ORIGINAL: (0xFF, 0xFF, 0xFF),
    MMObjectID.HILL_FORT_HOTA: (0xFF, 0x4E, 0x62),
    MMObjectID.RALLY_FLAG: (0xFF, 0x4E, 0x62),
    MMObjectID.IDOL_OF_FORTUNE: (0xFF, 0xA4, 0x64),
    MMObjectID.FOUNTAIN_OF_YOUTH: (0x8E, 0xFF, 0x4E),
    MMObjectID.MINERAL_SPRING: (0x76, 0xFF, 0xFF),
    MMObjectID.OASIS: (0x32, 0x9A, 0xFF),
    MMObjectID.WATERING_HOLE: (0xFF, 0xFA, 0xD4),
    MMObjectID.TEMPLE: (0xFF, 0xFA, 0xD4),
    MMObjectID.BUOY: (0xFF, 0xA4, 0x64),
    MMObjectID.TEMPLE_OF_LOYALTY: (0x32, 0x9A, 0xFF),
    MMObjectID.FAERIE_RING: (0x8E, 0xFF, 0x4E),
    MMObjectID.FOUNTAIN_OF_FORTUNE: (0x76, 0xFF, 0xFF),
    MMObjectID.SWAN_POND: (0x32, 0x9A, 0xFF),
    MMObjectID.MERMAIDS: (0xFF, 0x7D, 0x6E),
